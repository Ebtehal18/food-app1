...
<div className="d-flex details container-fluid  px-md-4 px-2 ">
    ...
    <div className="caption mb-2 mb-md-0">
      <h4 className="mb-0"> {adminData?.userGroup==='SystemUser'?'Show':'Fill'} the <span>Recipes</span>! </h4>
      <p className="mb-0">you can now {adminData?.userGroup==='SystemUser'?'show':'fill'}  the meals easily using the table and form , click here and sill it with the table !</p>
    </div>   


    <Link to={'/dashboard/recipes'} className={" btn-add px-3 py-2 text-decoration-none  px-md-5 py-md-3  text-white fw-bold"}>
    {adminData?.userGroup==='SystemUser'?'All':'Fill'} Recipes
